...
msg = (
    ...
    f"📁 *Deliverables & GitHub*:\n"
    f"• *GitHub*: Pushed to `origin/main` (`55fc6b0a0`)\n"
    f"• *Results & Logs*: All JSON, CSV, MD, TeX tables, PNG figures, and execution logs committed\n"
    f"• `tables/master_supplementary_table.{{md,tex,csv}}`\n"
    f"• `tables/frequency_feature_ablation_table.md`\n"
    f"• `tables/pca_ablation_table.md`\n"
    f"• `legacy2.0/logs/master_run.log`\n"
